...
/*        Project::create($input);*/
    ...
    public function update(Request $request, $id)
    {
        ...
        $search_engine = $project->search_engine_name;
        $se_language = $project->search_engine_language;
        $loc_name = $project->location_name;
        ...
        foreach ($search_key as $search_key_keyword)
        {
                ...
                Project::create(['projectName' => $project_name, 'projectUrl' => $project_url, 'keyword' => $search_key_keyword, 'user' => $user['id'], 'search_engine_name' => $search_engine,
                    'search_engine_id' => $se_id[0],'location_name' => $loc_name, 'location_id' => $loc_id[0], 'search_engine_language' => $se_language, 'frequency' => $frequency]);
    ...
    public function view_projects(){
        ...
        return view('project.all_projects');
    ...
    public function set_keyword()
    {
        ...
        return view('project.set_keyword');
   ...
   ';
    ...
    public function save_project(Request $request)
    {
        ...
        if (Input::get('save'))
        {
            ...
            Project::create(['projectName' => $project_name, 'projectUrl' => $project_url, 'user' => $user['id'], 'search_engine_name' => $search_engine, 'search_engine_id' => $se_id[0],
                'location_name' => $loc_name, 'location_id' => $loc_id[0], 'search_engine_language' => $se_language, 'frequency' => $frequency]);
